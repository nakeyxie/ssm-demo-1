...
<head>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${path}/static/ueditor1_4_3_3/ueditor.all.min.js">
    </script>
        ...
        function submitData() {
            ...
            $('#fm').form('submit',{
                ...
                success:function (result) {
                    ...
                    if(result.success) {
                        $.messager.alert("系统提示", "用户信息更新成功");
                    } else {
                        $.messager.alert("系统提示", "用户信息更新失败");
                        return;
                    }
                }
            });
...
<script>
    ...
    ue.addListener('ready',function () {
        UE.ajax.request('${path}/user/getUserInfo.do',{
            method: "post",
            async: false,
            data: {},
