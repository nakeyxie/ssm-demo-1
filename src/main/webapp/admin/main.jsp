...
<script>
        ...
        function openTab(text,url,icon) {
            ...
            if($('#tabs').tabs('exists',text)){
                ...
                $("#tabs").tabs('add',{
                    ...
                    iconCls:icon,    //显示图标
                    content:"<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='${path}/admin/"+url+"'></iframe>"
                    //url 远程加载所打开的url
                })
            }
        }
        ...
        function submitData() {
            $("#fm").form('submit',{
                url:'${path}/user/modtifyPassword.html',
                onsubmit:function () {
...
<body class="easyui-layout">
	...
	<div region="north" style="height: 78px; background-color: #E0ECFF">
        ...
        <tr>
            ...
            <td valign="bottom"
                ...
                align="right" width="50%"><font size="6">&nbsp;&nbsp;<strong>当前管理员:</strong><font color="red">${currentUser.username}</font>
                    </font>
            </td>
        </tr>
    </table>
	...
	<div region="west" style="width: 200px;" title="导航菜单"   split="true">
		<div class="easyui-accordion" data-options="fit:true,border:false">
			...
			<div title="文章管理" data-options="selected:true,iconCls:'icon-bkgl'"
				style="padding: 10px;">
				<a href="javascript:openTab('文章管理-UE','articleManage-ue.jsp','icon-writeblog')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-writeblog'"
					style="width: 150px;">UEditor</a> <a
					href="javascript:openTab('文章管理-KE','articleManage-ke.jsp','icon-bkgl')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">KindEditor(推荐)</a>
			</div>
			<div title="图片管理" data-options="iconCls:'icon-plgl'"
				style="padding: 10px">
				<a
					href="javascript:openTab(' 图片设置','pictureManage.jsp?type=1&grade=1','icon-plgl')"
					class="easyui-linkbutton"
	...
	<div region="south" style="height: 25px; padding: 5px" align="center">
		Copyright © 2017-2018  我的后台管理系统 版权所有</div>
</body>
</html>
