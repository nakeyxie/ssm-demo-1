...
<link href="${pageContext.request.contextPath}/static/css/tab.css"
	type="text/css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/static/css/item.css"
	type="text/css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/static/css/item_do.css"
	type="text/css" rel="stylesheet">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/uploadify.css"
	type="text/css"></link>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static//js/jquery.uploadify.v2.0.3.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/swfobject.js"></script>
<%
...
<body style="margin: 1px;" id="ff">
	<table id="dg" title="图片信息管理" class="easyui-datagrid" pagination="true"
		...
		url="${pageContext.request.contextPath}/admin/pictures/datagrid?type=<%=type %>&grade=<%=grade %>"
		toolbar="#tb">
	...
	<div id="tb">
		...
		<div>
			<table>
    		<tr>
    			<td>&nbsp;标题：&nbsp;<input type="text" id="articleTitle" size="20"onkeydown="if(event.keyCode==13) searchPicture()"/></td>
				...
				<div id="i_do_wrap">
					...
					<div class="i_do_div rel" id="i_no_sku_stock_wrap">
						...
						<input type="text" id="pictureUrl" name="url" value=""
							...
							type="hidden" id="pictureType" name="type" value="<%=type%>" /> <input
							type="hidden" id="pictureGrade" name="grade" value="<%=grade%>" />
						<input id="pictureId" name="id" type="hidden" value="0"> <input
...
<script type="text/javascript">
        ...
        $.messager.confirm("系统提示", "您确认要删除这<font color=red>"
            ...
            if (r) {
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/admin/pictures/" + ids,//url
                    data: {},
    ...
    function openPictureAddDialog() {
        ...
        $('#picture').append(html);
        var imghtml = '<img src="static/images/back.jpg" width="110" height="110" id="img11" style="display:none;/><input type="text" id="input11" name="path" value="" style="display:none;/>';
    ...
    function formatProPic(val, row) {
        return "<img width=100 height=100 src='${pageContext.request.contextPath}/upload/" + val + "'>";
    }
    ...
    function initUploadify() {
        $("#uploadify2").uploadify({
            ...
            'onComplete': function (evt, queueID, fileObj, response, data) {
                ...
                $("#img11").attr("src", imgUrl);//实现后台预览功能
                $("#input11").val(imgUrl);
